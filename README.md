...
```bash
UUID=your-uuid ARGO_DOMAIN=your.domain ARGO_AUTH=your-token bash <(curl -sL https://raw.githubusercontent.com/zaofengyue/nodex-sb/main/install.sh)
```
